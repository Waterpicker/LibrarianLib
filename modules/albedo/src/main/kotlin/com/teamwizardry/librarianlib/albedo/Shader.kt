    ...
    private companion object {
        ...
        init {
            Client.resourceReloadHandler.register(object: ISimpleReloadListener<Any?> {
                override fun prepare(resourceManager: ResourceManager, profiler: Profiler): Any? = null

                override fun apply(result: Any?, resourceManager: ResourceManager, profiler: Profiler) {
